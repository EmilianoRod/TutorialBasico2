...
public class MyStepdefs {
    ...
    public void iEnterAWordInTheSearchField()  {  googleSearch.enterSearchCriteria("www.TheFreeRangeTester.com"); }

    @And("^click on the search button$")
    public void clickOnTheSearchButton()  {  googleSearch.clickOnSearchGoogle();  }
